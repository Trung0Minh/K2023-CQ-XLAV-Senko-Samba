...
import math
import time
from .vmamba import Backbone_VSSM, SaliencyMambaBlock
from ..HA import HA
...
class RGBXMamba(nn.Module):
    def __init__(self, 
        ...
        self.pred_saliency = nn.Conv2d(in_channels=int(dims * (2 ** (len(depths) - 1))), out_channels=1, kernel_size=1, bias=False)
