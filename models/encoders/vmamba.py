...
if True:
    ...
    def selective_scan_ref(u, delta, A, B, C, D=None, delta_bias=None, delta_softplus=False, nrows=1):
        """
        u: r(B D L)
        delta: r(B D L)
        A: c(D N) or r(D N)
    ...
    class SelectiveScan:
        @staticmethod
        def apply(u, delta, A, B, C, D=None, delta_bias=None, delta_softplus=False, nrows=1):
            return selective_scan_ref(u, delta, A, B, C, D, delta_bias, delta_softplus, nrows)
